...
describe('SelectField', function () {
  ...
  it('renders a SelectField', function () {
    ...
    }).render()).toEqualJSX(_react2.default.createElement(_SelectField2.default, { name: 'mySelect', value: 'Foo', onChange: _lodash2.default, ref: 'component', onBlur: _lodash2.default }));
  });
  ...
  it('renders a SelectField with an error', function () {
    (0, _expect2.default)(new _SelectField4.default({
      ...
      ref: 'component', onBlur: _lodash2.default }));
  });
  ...
  it('maps onChange from Field property properly', function () {
    ...
    var dom = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(
      _MuiThemeProvider2.default,
      { muiTheme: (0, _getMuiTheme2.default)() },
      _react2.default.createElement(_SelectField4.default, { name: 'mySelect', input: { onChange: reduxFormOnChange, value: 'Foo' }, onChangeFunc: fieldOnChange })
    ));
    ...
    (0, _expect2.default)(fieldOnChange).toHaveBeenCalled().toHaveBeenCalledWith(42, 'TheValue');
  });
  ...
  it('calls onBlur with currently selected value', function () {
    ...
    var dom = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(
      _MuiThemeProvider2.default,
      { muiTheme: (0, _getMuiTheme2.default)() },
      _react2.default.createElement(_SelectField4.default, { name: 'mySelect', input: { value: 'Foo', onBlur: fieldOnBlur } })
    ));
