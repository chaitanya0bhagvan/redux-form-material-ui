...
describe('RadioButtonGroup', function () {
  ...
  it('renders a RadioButtonGroup', function () {
    ...
    }).render()).toEqualJSX(_react2.default.createElement(_RadioButton.RadioButtonGroup, { name: 'myRadio', onChange: _lodash2.default, value: 'Foo', valueSelected: 'Foo', ref: 'component' }));
  });
  ...
  it('renders a RadioButtonGroup with an error', function () {
    ...
    }).render()).toEqualJSX(_react2.default.createElement(_RadioButton.RadioButtonGroup, { name: 'myRadio', onChange: _lodash2.default, value: 'Foo', valueSelected: 'Foo', errorText: 'FooError',
      ref: 'component' }));
  });
  ...
  it('renders a RadioButtonGroup with an warning', function () {
    ...
    }).render()).toEqualJSX(_react2.default.createElement(_RadioButton.RadioButtonGroup, { name: 'myRadio', onChange: _lodash2.default, value: 'Foo', valueSelected: 'Foo', errorText: 'FooWarning',
      ref: 'component' }));
  });
