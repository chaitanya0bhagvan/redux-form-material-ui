...
exports.default = (0, _createComponent2.default)(_Slider2.default, function (_ref) {
  ...
  var onChangeFunc = _ref.onChange;

  var props = _objectWithoutProperties(_ref, ['input', 'onChange']);

  return (// eslint-disable-line no-unused-vars
    _extends({}, (0, _mapError2.default)(_extends({}, props, { input: _extends({}, inputProps, { value: inputProps.value === "" ? props.defaultValue : inputProps.value }) }), 'error'), {
