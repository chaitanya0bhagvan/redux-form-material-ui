...
exports.default = (0, _createComponent2.default)(_Checkbox2.default, function (_ref) {
  ...
  var inputProps = _objectWithoutProperties(_ref$input, ['onChange', 'value']);

  var meta = _ref.meta;
  var onCheckFunc = _ref.onCheck;

  var props = _objectWithoutProperties(_ref, ['input', 'meta', 'onCheck']);
